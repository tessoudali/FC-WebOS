...
new explorer.window()
.title('Block Browser - FloydCraft') //set the title
...
.callback(function() {
	...
	bod.html('<button class="b1"><img src="https://i.imgur.com/2TjTMxE.png" draggable="false" width="20" height="22"/><button class="b7"><img src="https://i.imgur.com/sfO4g4a.png" draggable="false" width="21" height="23"/><button class="b6"><img src="https://i.imgur.com/NANDJf8.png" draggable="false" width="20" height="22"/></button><button class="b2"><img src="https://i.imgur.com/Af5inxU.png" draggable="false" width="20" height="22"/><button class="b4"><img src="https://i.imgur.com/m1ur3mh.png" draggable="false" width="20" height="22"/></button><button class="b5"><img src="https://i.imgur.com/ptqaUfE.png" draggable="false" width="20" height="22"/></button></button><input class="i1"></input><button class="b3"><img src="https://i.imgur.com/YiWAXpO.png" draggable="false" height="22"/></div></button><iframe src="http://cdn.floydcraft.co.uk" class="if1"></iframe>');
	...
	function startTracker() {
		...
		var interval = setInterval(function() {
			...
			try {
				...
				bod.find('input.i1').attr('placeholder', 'This browser has been automatically optimised for the FloydCraft Website.');
			}
